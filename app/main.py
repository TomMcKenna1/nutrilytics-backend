...
from app.api.v1 import account, auth as auth_v1, meals, metrics, tdee, weight_logs
...
app.include_router(
    weight_logs.router, prefix="/api/v1/weightLogs", tags=["Weight Logs"]
)
app.include_router(tdee.router, prefix="/api/v1/tdee", tags=["TDEE"])
